...
def register():
    ...
    host_script = project_root / 'src' / 'nova' / 'core' / 'browser_host.py'
    manifest_template = project_root / 'src' / 'nova' / 'core' / 'native_manifest.json'
    manifest_output = project_root / 'src' / 'nova' / 'core' / 'zyron_native_host.json'
    ...
    # 3. Registry update
    reg_key = r"Software\Mozilla\NativeMessagingHosts\nova.native.host"
    try:
        ...
        print(f"✅ Successfully registered Nova Native Host in Registry.")
