// Background service worker for NOVA Activity Monitor
console.log("NOVA Activity Monitor - Background Service Started");

let nativePort = null;

function connectToNativeHost() {
  nativePort = chrome.runtime.connectNative("nova.native.host");
